...
- **Name:** `DecomposeVector3`
- **UI Name:** Decompose Vector3
- **Version:** 1
...
|----------|--------------|------|---------|---------------|----------|
| vector | Vector | Float3 | Input | \[0\.0, 0\.0, 0\.0\] | No | 
...
| Property | Display Name | Type | IO Type | Default Value | Optional |
|----------|--------------|------|---------|---------------|----------|
| x | X | Float | Output | 0\.0 | No | 
| y | Y | Float | Output | 0\.0 | No | 
| z | Z | Float | Output | 0\.0 | No | 
